...
const appConfigs = {
  ...
  ...externalPatchAppConfigs([
    ...
    ["1111-warp", "1.1.1.1 + WARP", "com.cloudflare.onedotonedotonedotone", { apkmirrorOrg: "cloudflare-inc", apkmirrorRepo: "1-1-1-1-faster-internet", apkmirrorSlug: "1-1-1-1-faster-internet", apkmirrorType: "bundle", apkmirrorFallbackArch: "universal", apkmirrorDpi: "nodpi" }],
    ["adguard-nightly", "AdGuard Nightly", "com.adguard.android.contentblocker.nightly"],
