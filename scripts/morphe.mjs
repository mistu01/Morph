...
const appConfigs = {
  ...
  twitter: {
    ...
    apkmirrorFallbackArch: env("TWITTER_APKMIRROR_FALLBACK_ARCH") || env("APKMIRROR_FALLBACK_ARCH") || "universal",
  ...
  instagram: {
    ...
    apkmirrorFallbackArch: env("INSTAGRAM_APKMIRROR_FALLBACK_ARCH") || env("APKMIRROR_FALLBACK_ARCH") || "universal",
