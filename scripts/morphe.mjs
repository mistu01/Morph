...
const appConfigs = {
  ...
  "google-photos": {
    ...
    apkmirrorType: env("GOOGLE_PHOTOS_APKMIRROR_TYPE") || env("APKMIRROR_TYPE") || "apk",
    apkmirrorArch: env("GOOGLE_PHOTOS_APKMIRROR_ARCH") || env("APKMIRROR_ARCH") || "arm64-v8a",
    apkmirrorFallbackArch: env("GOOGLE_PHOTOS_APKMIRROR_FALLBACK_ARCH") || env("APKMIRROR_FALLBACK_ARCH") || "",
    apkmirrorDpi: env("GOOGLE_PHOTOS_APKMIRROR_DPI") || env("APKMIRROR_DPI") || "nodpi",
