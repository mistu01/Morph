...
const appConfigs = {
  ...
  ...externalPatchAppConfigs([
    ...
    ["1111-warp", "1.1.1.1 + WARP", "com.cloudflare.onedotonedotonedotone", { apkmirrorOrg: "cloudflare", apkmirrorRepo: "1-1-1-1-faster-safer-internet", apkmirrorSlug: "1-1-1-1-faster-safer-internet", apkpureSlug: "1-1-1-1-faster-safer-internet", apkmirrorType: "bundle", apkmirrorFallbackArch: "universal", apkmirrorDpi: "nodpi" }],
    ...
    ["windscribe", "Windscribe VPN", "com.windscribe.vpn", { apkmirrorOrg: "windscribe", apkmirrorRepo: "windscribe", apkmirrorSlug: "windscribe", apkpureSlug: "windscribe-vpn-fast-secure" }],
